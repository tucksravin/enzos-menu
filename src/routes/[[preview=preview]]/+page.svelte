...
<div class='w-screen h-screen p-12 bg-white relative'>	
	<div class='w-full h-full relative'>
		{#if !isFeatureActive}
			<div class='w-full h-full absolute bg-[#FFF6ED] flex flex-col justify-between py-8 px-16' in:fly={{x:'-100%'}} out:fly={{x:'100%'}}>
		...
		{:else}
			<div in:fly={{x:'-100%'}} out:fly={{x:'100%'}} class='w-full h-full absolute bg-[#FFF6ED] flex flex-row justify-between  pl-16'>
